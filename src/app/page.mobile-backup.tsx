...
export default function Home() {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-white text-slate-900 antialiased selection:bg-blue-200">
      <style jsx global>{`
        @keyframes dash {
          to {
      ...
      <main className="pointer-events-none absolute inset-0 z-20">
        ...
        <div className="animate-fade-in absolute left-8 top-[45%] z-30 max-w-xl -translate-y-1/2 opacity-0 md:left-12">
          <h1 className="headline-shimmer text-5xl font-bold leading-[1.05] tracking-tight md:text-6xl">
            Build Tomorrow,
            <br />
            Today.
          </h1>
          ...
          <div className="pointer-events-auto mt-8 flex gap-4">
            ...
            <a
              href="/contact"
              className="rounded-full border border-blue-600/20 bg-white/70 px-6 py-3 text-sm font-medium text-blue-700 shadow-sm backdrop-blur transition hover:bg-blue-50"
            >
              Book Consultation
            </a>
          </div>
