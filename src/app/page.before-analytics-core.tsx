...
export default function Home() {
  ...
  return (
    <div className="relative min-min-h-screen w-full overflow-x-hidden bg-white text-[#0a0c0e] antialiased selection:bg-cyan-300">
      ...
      <section className="relative z-30 mt-[100vh] bg-white px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center">
            <p className="mb-4 font-mono text-[11px] font-semibold uppercase tracking-[0.35em] text-cyan-600">
              PORTFOLIO INTELLIGENCE
            </p>

            <h2 className="mx-auto max-w-4xl text-4xl font-semibold tracking-tight text-[#0a0c0e] sm:text-5xl md:text-6xl">
          ...
          <div className="relative mx-auto max-w-5xl overflow-hidden rounded-[2rem] border border-black/5 bg-white/80 p-6 shadow-[0_30px_100px_-60px_rgba(0,0,0,0.35)] backdrop-blur sm:p-10">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(0,145,255,0.10),transparent_65%)]" />
            ...
            <div className="relative grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                <div
                  key={label}
                  className="group rounded-3xl border border-black/5 bg-[#f6f8fb] p-6 transition duration-300 hover:border-cyan-400 hover:bg-white"
                >
                  <div className="mb-6 h-px w-full bg-gradient-to-r from-transparent via-cyan-400 to-transparent opacity-60" />

                  <p className="text-4xl font-semibold tracking-tight text-[#0a0c0e] sm:text-5xl">
                    <span className="headline-shimmer">{value}</span>
                  </p>
            ...
            <div className="relative mt-8 grid gap-4 sm:grid-cols-3">
              {[
                ...
                <div
                  key={item}
                  className="rounded-2xl border border-cyan-400/40 bg-white/70 px-5 py-4 text-center text-sm font-semibold uppercase tracking-[0.2em] text-cyan-600"
                >
                  {item}
                </div>
              ))}
