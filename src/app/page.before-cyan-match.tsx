...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-white text-slate-900 antialiased selection:bg-blue-200">
      <style jsx global>{`
        @keyframes dash {
          to {
      ...
      <div
        ref={blobRef}
        className="pointer-events-none absolute z-0 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(37,99,235,0.12)_0%,rgba(255,255,255,0)_70%)]"
      />
      ...
      <div className="absolute inset-0 z-10">
        {labels.map((item, i) => (
          ...
          >
            <div className="absolute h-[3px] w-[3px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-600 shadow-[0_0_8px_rgba(37,99,235,0.9)]" />
            <div className="absolute left-[-3px] top-[-3px] h-2 w-2 -translate-x-1/2 -translate-y-1/2 border-l border-t border-blue-500/40" />
            <div className="absolute bottom-[-3px] right-[-3px] h-2 w-2 -translate-x-1/2 -translate-y-1/2 border-b border-r border-blue-500/40" />
            <div className="absolute left-2.5 top-2.5 whitespace-nowrap rounded-[1px] bg-blue-600 px-1 py-[1px] font-mono text-[8px] tracking-[0.05em] text-white">
              {item.text}
            </div>
          </div>
        ))}
      ...
      <main className="pointer-events-none absolute inset-0 z-20">
        <header className="animate-fade-in absolute left-5 top-6 opacity-0 sm:left-8 sm:top-8 md:left-12">
          <span className="font-mono text-[10px] font-bold tracking-[0.2em] text-blue-700">
            SEAINT ENTERPRISE
          </span>
        </header>
        ...
        <div className="animate-fade-in absolute left-5 right-5 top-[48%] sm:left-8 sm:right-auto sm:top-[45%] z-30 max-w-xl md:left-12 -translate-y-1/2 opacity-0 md:left-12">
          ...
          <p className="mt-5 max-w-[320px] font-mono text-[9px] uppercase tracking-[0.22em] sm:max-w-none sm:text-[10px] sm:tracking-widest text-slate-500">
          ...
          <div className="pointer-events-auto mt-7 flex flex-col gap-3 sm:mt-8 sm:flex-row sm:gap-4">
            <a
              href="/portfolio"
              className="rounded-full bg-blue-600 px-5 py-3 text-center text-sm sm:px-6 font-medium text-white transition hover:bg-blue-700"
            >
              View Portfolio
            </a>
            ...
            <a
              href="/contact"
              className="rounded-full border border-blue-600/20 bg-white/70 px-5 py-3 text-center text-sm sm:px-6 font-medium text-blue-700 shadow-sm backdrop-blur transition hover:bg-blue-50"
            >
              Book Consultation
            </a>
          </div>
