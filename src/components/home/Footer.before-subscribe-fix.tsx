        ...
        <div className="relative z-10 p-8 sm:p-12 md:p-16">
          ...
          <div className="grid grid-cols-2 gap-8 pt-12 sm:grid-cols-3 lg:grid-cols-4">
            ...
            <div>
              ...
              <form className="mt-3 flex items-center gap-2">
                <input type="email" placeholder="you@example.com" className="w-full rounded-xl border border-black/5 bg-white px-3 py-2.5 text-xs outline-none placeholder:text-gray-400 focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/30" />
          ...
          <div className="mt-10 flex flex-col items-start justify-between gap-3 border-t border-black/5 pt-6 text-sm text-gray-500 sm:flex-row sm:items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="#top" className="hover:text-cyan-600">Back to top ↑</a>
            </div>
          </div>
        </div>
      </div>
